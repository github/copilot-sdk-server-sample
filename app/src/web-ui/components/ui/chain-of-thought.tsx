  ...
  return (
    ...
    >
      <div className="grid grid-cols-[min-content_minmax(0,1fr)] gap-x-4">
        <div className="bg-primary/20 ml-1.75 h-full w-px group-data-[last=true]/step:hidden" />
        <div className="ml-1.75 h-full w-px bg-transparent group-data-[last=false]/step:hidden" />
